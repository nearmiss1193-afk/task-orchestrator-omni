...
# 1. Prepare Base64
try:
    with open('frame_b64.txt', 'r', encoding='utf-16') as f:
        b64 = f.read().strip()
except Exception as e:
    print(f"Error reading frame_b64.txt: {e}")
    sys.exit(1)

# 2. Generate Asset File
with open('assets_data.py', 'w', encoding='utf-8') as f:
    f.write(f'FRAME_B64 = "{b64}"\\n')
...
with open('deploy_hvac_vsl.py', 'w', encoding='utf-8') as f:
    f.write(deploy_code)

print("✅ Modular build complete.")
