def get_cleaning_landing_html(calendly_url="#", stripe_url="#"):
    title = "AI Cleaning Service Dispatch"
    hook = "Spotless Sales Process."
    agent_name = "Maid Mary"
    ...
    <script>
      ...
      try {{
          vapiInstance = window.vapiSDK.run({{
            ...
            config: {{
                idle: {{ color: "{color}", type: "pill", title: "Book Clean", subtitle: "{agent_name}", icon: "https://unpkg.com/lucide-static@0.321.0/icons/sparkles.svg" }}
            }}
          }});
...
<body>
    <div class="container">
        ...
        <h1>{hook} <span class="highlight">Sparkling.</span></h1>
        <p style="font-size: 20px; color: #94a3b8; max-width: 600px; margin-bottom: 40px;">
            Coordinate teams, book deep cleans, and handle rescheduling automatically. Mary never misses a speck of dust or a lead.
        </p>
