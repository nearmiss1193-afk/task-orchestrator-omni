def get_autodetail_landing_html(calendly_url="#", stripe_url="#"):
    title = "AI Auto Detail Booking"
    hook = "Mobile Detailing? Automate It."
    agent_name = "Detail Dave"
    ...
    <script>
      ...
      try {{
          vapiInstance = window.vapiSDK.run({{
            ...
            config: {{
                idle: {{ color: "{color}", type: "pill", title: "Book Detail", subtitle: "{agent_name}", icon: "https://unpkg.com/lucide-static@0.321.0/icons/car.svg" }}
            }}
          }});
...
<body>
    <div class="container">
        ...
        <h1>{hook} <span class="highlight">Premium.</span></h1>
        <p style="font-size: 20px; color: #94a3b8; max-width: 600px; margin-bottom: 40px;">
            Dave up-sells ceramic coatings and manages your mobile fleet's schedule. Stop answering texts while you're buffing.
        </p>
