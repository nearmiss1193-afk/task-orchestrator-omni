"use strict";(()=>{var e={};e.id=597,e.ids=[597],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},5089:(e,t,s)=>{s.r(t),s.d(t,{originalPathname:()=>d,patchFetch:()=>g,requestAsyncStorage:()=>p,routeModule:()=>u,serverHooks:()=>m,staticGenerationAsyncStorage:()=>l});var r={};s.r(r),s.d(r,{POST:()=>c});var a=s(3278),o=s(5002),n=s(4877),i=s(1309);async function c(e){try{let{industry:t,companySize:s,primaryChallenge:r,currentCRM:a,email:o}=await e.json();console.log(`[LEAD CAPTURED] Assessment completed for ${o} in ${t}`);let n=`You are an elite AI Automation Architect. A local service business owner just took our "AI Readiness Assessment".
