"use strict";(()=>{var e={};e.id=597,e.ids=[597],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8465:(e,t,s)=>{s.r(t),s.d(t,{originalPathname:()=>d,patchFetch:()=>g,requestAsyncStorage:()=>p,routeModule:()=>u,serverHooks:()=>m,staticGenerationAsyncStorage:()=>l});var r={};s.r(r),s.d(r,{POST:()=>c});var a=s(9303),o=s(8716),n=s(670),i=s(7070);async function c(e){try{let{industry:t,companySize:s,primaryChallenge:r,currentCRM:a,email:o}=await e.json();console.log(`[LEAD CAPTURED] Assessment completed for ${o} in ${t}`);let n=`You are an elite AI Automation Architect. A local service business owner just took our "AI Readiness Assessment".
