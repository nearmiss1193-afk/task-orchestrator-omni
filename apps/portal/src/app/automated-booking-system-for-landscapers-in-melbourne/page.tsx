...
export const metadata: Metadata = {
    title: "Automated Booking System for Landscapers in Melbourne, FL | AI Service Co",
    description: "AI Service Co provides advanced 24/7 Automated Booking Systems for Landscapers in the Melbourne area. Stop missing calls and start booking more revenue automatically.",
};
...
export default function AgencySeoPage() {
    const schemaData = {
        ...
        '@type': 'Service', 
        'name': 'Automated Booking System for Landscapers in Melbourne, FL', 
        'provider': {
            '@type': 'LocalBusiness', 
            'name': 'AI Service Co', 
    ...
    return (
        <div className="min-h-screen bg-zinc-50 font-sans text-zinc-900">
            <Script
                id="schema-automated-booking-system-for-landscapers-in-melbourne"
                ...
                <div className="p-8 bg-white border border-zinc-200 rounded-2xl shadow-sm mb-8">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <h1 className="text-5xl font-black mb-2 text-zinc-900 tracking-tight">Automated Booking System for Landscapers <br/>in <span className="text-blue-600">Melbourne, FL</span></h1>
                        </div>
                    </div>
                    
                    <div className="prose prose-zinc max-w-none mb-8">
                        <p className="text-lg leading-relaxed text-zinc-700 font-medium">
                            AI Service Co provides advanced 24/7 Automated Booking Systems for Landscapers in the Melbourne area. Stop missing calls and start booking more revenue automatically.
                        </p>
                    </div>
