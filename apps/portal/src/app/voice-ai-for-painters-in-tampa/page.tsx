...
export const metadata: Metadata = {
    title: "Voice AI for Painters in Tampa, FL | AI Service Co",
    description: "AI Service Co provides advanced 24/7 Voice AIs for Painters in the Tampa area. Stop missing calls and start booking more revenue automatically.",
};
...
export default function AgencySeoPage() {
    const schemaData = {
        ...
        '@type': 'Service', 
        'name': 'Voice AI for Painters in Tampa, FL', 
        'provider': {
            '@type': 'LocalBusiness', 
            'name': 'AI Service Co', 
    ...
    return (
        <div className="min-h-screen bg-zinc-50 font-sans text-zinc-900">
            <Script
                id="schema-voice-ai-for-painters-in-tampa"
                ...
                <div className="p-8 bg-white border border-zinc-200 rounded-2xl shadow-sm mb-8">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <h1 className="text-5xl font-black mb-2 text-zinc-900 tracking-tight">Voice AI for Painters <br/>in <span className="text-blue-600">Tampa, FL</span></h1>
                        </div>
                    </div>
                    
                    <div className="prose prose-zinc max-w-none mb-8">
                        <p className="text-lg leading-relaxed text-zinc-700 font-medium">
                            AI Service Co provides advanced 24/7 Voice AIs for Painters in the Tampa area. Stop missing calls and start booking more revenue automatically.
                        </p>
                    </div>
