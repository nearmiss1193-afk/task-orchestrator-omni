...
export const metadata: Metadata = {
    title: "Friends Plumbing Tampa | Best plumbing company in Lakeland",
    description: "Friends Plumbing Tampa is a premium plumbing company serving the Lakeland area. Contact them today for expert service in Polk county....",
};

export default function BusinessProfilePage() {
    const schemaData = {'@context': 'https://schema.org', '@type': 'LocalBusiness', 'name': 'Friends Plumbing Tampa', 'telephone': '', 'url': 'https://friendsplumbing.com', 'aggregateRating': {'@type': 'AggregateRating', 'ratingValue': '5.0', 'reviewCount': '1'}, 'address': {'@type': 'PostalAddress', 'addressLocality': 'Lakeland', 'addressRegion': 'FL'}};

    return (
        <div className="min-h-screen bg-zinc-50 font-sans text-zinc-900">
            <Script
                id="schema-friends-plumbing-tampa"
            ...
            <nav className="py-4 px-8 text-sm text-zinc-500 border-b border-zinc-200 bg-white">
                ...
                <span className="mx-2">›</span>
                <span className="text-zinc-800 font-bold">Friends Plumbing Tampa</span>
            </nav>
            ...
            <main className="max-w-4xl mx-auto px-8 py-16">
                <div className="p-8 bg-white border border-zinc-200 rounded-2xl shadow-sm mb-8">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            <h1 className="text-4xl font-black mb-2 text-zinc-900">Friends Plumbing Tampa</h1>
                    ...
                    <div className="prose prose-zinc max-w-none mb-8">
                        <p className="text-lg leading-relaxed text-zinc-700">
                            Friends Plumbing Tampa is a premium plumbing company serving the Lakeland area. Contact them today for expert service in Polk county.
                        </p>
                    </div>
                    
                    <div className="flex gap-4 border-t border-zinc-100 pt-8">
                        
                        <a href="https://friendsplumbing.com" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-zinc-100 hover:bg-zinc-200 text-zinc-800 font-bold rounded-xl transition-colors">Visit Website</a>
                    </div>
                </div>
