                ...
                <div className="p-8 bg-white border border-zinc-200 rounded-2xl shadow-sm mb-8">
                    ...
                    <div className="prose prose-zinc max-w-none mb-8">
                        <p className="text-lg leading-relaxed text-zinc-700">
                            Looking for a reliable moving company in Lakeland FL? Two Men and a Truck Moving and Storage is your trusted local partner for stress-free relocations. As a premier local moving company, we’ve proudly served Lakeland and the entire Polk county area for years, building a reputation for professionalism and exceptional service. Whether you're moving across town, across Florida, or need secure storage solutions, our dedicated team handles your belongings with the utmost care. We understand the unique needs of our community, offering tailored services that make your relocation smooth and efficient. From meticulous packing and careful loading to safe transportation and precise unpacking, count on our experienced movers for a seamless experience. Choose Two Men and a Truck, the local experts who deliver peace of mind with every move in Lakeland, FL.
                        </p>
                    </div>
