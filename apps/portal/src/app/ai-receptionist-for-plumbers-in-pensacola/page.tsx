...
export const metadata: Metadata = {
    title: "AI Receptionist for Plumbers in Pensacola, FL | AI Service Co",
    description: "AI Service Co provides advanced 24/7 AI Receptionists for Plumbers in the Pensacola area. Stop missing calls and start booking more revenue automatically.",
};
...
export default function AgencySeoPage() {
    const schemaData = {
        ...
        '@type': 'Service', 
        'name': 'AI Receptionist for Plumbers in Pensacola, FL', 
        'provider': {
            '@type': 'LocalBusiness', 
            'name': 'AI Service Co', 
    ...
    return (
        <div className="min-h-screen bg-zinc-50 font-sans text-zinc-900">
            <Script
                id="schema-ai-receptionist-for-plumbers-in-pensacola"
                ...
                <div className="p-8 bg-white border border-zinc-200 rounded-2xl shadow-sm mb-8">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            ...
                            <h1 className="text-5xl font-black mb-2 text-zinc-900 tracking-tight">AI Receptionist for Plumbers <br/>in <span className="text-blue-600">Pensacola, FL</span></h1>
                        </div>
                    </div>
                    
                    <div className="prose prose-zinc max-w-none mb-8">
                        <p className="text-lg leading-relaxed text-zinc-700 font-medium">
                            AI Service Co provides advanced 24/7 AI Receptionists for Plumbers in the Pensacola area. Stop missing calls and start booking more revenue automatically.
                        </p>
                    </div>
