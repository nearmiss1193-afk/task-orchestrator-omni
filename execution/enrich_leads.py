...
def _enrich_mass_batch_inner(input_file):
    ...
    for lead in leads:
        ...
        # SIMULATED SIMILAR WEB / MANUS AI DATA
        monthly_visits = random.randint(100, 5000)
        direct_traffic = random.randint(40, 70)
        ai_search_traffic = random.randint(1, 10)
        revenue_range = random.choice(["$1M - $5M", "$5M - $10M", "Under $1M"])
        ...
        enriched_results.append({
            **lead,
            ...
            "aeo_data": {
                ...
                "direct_traffic_pct": direct_traffic,
                "ai_search_traffic_pct": ai_search_traffic,
                "revenue_range": revenue_range,
                "primary_source": "Direct" if direct_traffic > 50 else "Search"
            },
            "leaks": ["No instant text-back", "Slow site load", "AI Invisibility (AEO Gap)"]
        })
