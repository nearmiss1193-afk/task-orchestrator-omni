...
| ORCHESTRATOR_ASSISTANT_ID | `033ec1d3-e17d-4611-a497-b47cab1fdb4e` | Dashboard voice (commander) |
| SARAH_ASSISTANT_ID | `1a797f12-e2dd-4f7f-b2c5-08c38c74859a` | Customer campaigns |
...
| Assistant | ID | Role |
|-----------|-----|------|
| **Empire Office Manager** | `033ec1d3...` | Orchestrator - talks to YOU on dashboard |
| **Sarah the Spartan** | `1a797f12...` | Customer-facing - answers calls, campaigns |
| **Empire Sales Specialist** | `d19cae13...` | Sales calls from landing pages |
